...
class AdmobGodot(godot: Godot) : GodotPlugin(godot), BannerAdListener, InterstitialAdListener, RewardedAdListener, ConsentListener {
  ...
  companion object {
    ...
    val SIGNAL_BANNER_AD_FAILED_TO_LOAD = SignalInfo("on_banner_ad_failed_to_load", Int::class.java)
    ...
    val SIGNAL_INTERSTITIAL_AD_FAILED_TO_LOAD = SignalInfo("on_interstitial_ad_failed_to_load", Int::class.java)
    ...
    val SIGNAL_REWARDED_AD_FAILED_TO_LOAD = SignalInfo("on_rewarded_ad_failed_to_load", String::class.java, Int::class.java)
    ...
    val SIGNAL_REWARDED_AD_EARNED = SignalInfo("on_rewarded_ad_earned", String::class.java, String::class.java, Int::class.java)
    val SIGNAL_REWARDED_AD_FAILED_TO_SHOW = SignalInfo("on_rewarded_ad_failed_to_show", String::class.java, Int::class.java)
